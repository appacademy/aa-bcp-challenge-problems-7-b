...
const numberPrimes = require('../problems/1-number-primes.js');
const longestBigram = require('../problems/2-longest-bigram.js');
const longestLetterStreak = require('../problems/3-longest-letter-streak.js');
const previousPrimeArray = require('../problems/4-previous-prime-array.js');
...
describe('longestBigram()', function () {
  it('should return the longest bigram of the sentence', function () {
    ...
    assert.equal(
      longestBigram('this last assessment is fun'),
      'last assessment'
    );
    assert.equal(
      longestBigram('say goodbye bootcamp prep'),
      'goodbye bootcamp'
    );
...
describe('previousPrimeArray()', function () {
  it('should return a new array where each prime is replaced with the prime that comes before it', function () {
    assert.deepStrictEqual(
      previousPrimeArray([10, 12, 11, 7, 16]),
      [10, 12, 7, 5, 16]
    );
    assert.deepStrictEqual(previousPrimeArray([17, 24, 29, 5, 2, 4]), [
      13,
      24,
      23,
      3,
    ...
    assert.deepStrictEqual(previousPrimeArray([1, 2, 3, 4, 5]), [
      1,
      null,
      2,
      4,
